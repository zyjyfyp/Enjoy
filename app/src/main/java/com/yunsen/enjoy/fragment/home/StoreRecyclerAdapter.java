...
public class StoreRecyclerAdapter extends CommonAdapter<CarStoreMode> {
    public StoreRecyclerAdapter(Context context, int layoutId, List<CarStoreMode> datas) {
        super(context, layoutId, datas);
    }

    @Override
    protected void convert(ViewHolder holder, CarStoreMode carStoreMode, int position) {
