...
//        private String vip_card;
    ...
    public static UserInfo getUserInfo() {
        ...
        userInfo.setUser_code(sp.getString(SpConstants.USER_CODE, "" + userInfo.getUser_code()));
        userInfo.setStatus(Integer.valueOf(sp.getString(SpConstants.STATUS, "" + userInfo.getStatus())));
        return userInfo;
    }
