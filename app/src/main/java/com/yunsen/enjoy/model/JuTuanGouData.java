...
public class JuTuanGouData {
	...
	public void setCashing_point(String cashing_point) {
	...
	public void setGroupon_item_people(int groupon_item_people) {
	...
	public void setGroupon_item_member(int groupon_item_member) {
		this.groupon_item_member = groupon_item_member;
	}

	public String getGroupon_item_id() {
		return groupon_item_id;
	}

	public void setGroupon_item_id(String groupon_item_id) {
		this.groupon_item_id = groupon_item_id;
	}
